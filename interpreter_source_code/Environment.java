...
public class Environment implements Cloneable{
    ...
    void assign(Token name, Object value){
        ...
        Runtime.error( "Undefined variable '" + name.value.toString() + "'", name.line, name.file_name);
    }
    ...
    Object get(Token identifier){
        ...
        Runtime.error("variable '" + identifier.value + "' has NOT been defined", identifier.line, identifier.file_name);
        return null;
    }
